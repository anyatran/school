...
// abstract
abstract class AFiles implements IFile {
    String name;
    String owner;

    AFiles(String name, String owner) {
        this.name = name;
        this.owner = owner;
    }
    ...
    // compute the time (in seconds) to download this file
    // at the given download rate
    public abstract int downloadTime(int rate);
...
class ImageFile extends AFiles {
    int width; // in pixels
...
class AudioFile extends AFiles {
