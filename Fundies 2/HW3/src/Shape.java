...
class MtLoS implements ILoS {
    ...
    // creates a new list of Strings out of this list that starts with a given letter 
    public ILoS filter(String b) {
        return this;
    }
}
...
class ExamplesStrings{
    ...
    ILoS mcDonald = new ConsLoS("Old ",
            new ConsLoS("McDonald ",
                    new ConsLoS("had ",
                            new ConsLoS("a ",
    ...
    ILoS maryMcDonald = new ConsLoS("a ", new ConsLoS("a ",
            new ConsLoS("farm.", new ConsLoS("had ", new ConsLoS("had ",
    ...
    boolean testCorrectPlace(Tester t){
        return 
                t.checkExpect(this.mt.correctPlace("a"), true) &&
    ...
    boolean testInsert(Tester t) {
        return
                t.checkExpect(this.mt.insert("a"), new ConsLoS("a", mt)) &&
                t.checkExpect(this.mcDonaldSorted.insert("b "), 
                        new ConsLoS("a ", new ConsLoS("b ",
                                new ConsLoS("farm.", new ConsLoS("had ",
                                        new ConsLoS("mcdonald ",
                                                new ConsLoS("old ",
                                                        new MtLoS())))))));
    }
    ...
    boolean testMerge(Tester t) {
        return 
                t.checkExpect(this.mt.merge(marySorted), marySorted) &&
                t.checkExpect(this.marySorted.merge(mcDonaldSorted), maryMcDonald);
    } 

    // tests for mergeHelper()
    boolean testMergeHelper(Tester t) {
        return
                t.checkExpect(this.mt.mergeHelper("a "), new ConsLoS("a ", mt)) &&
    ...
    boolean testFilter(Tester t) {
        return 
                t.checkExpect(this.mt.filter("a"), mt) &&
                t.checkExpect(this.mary.filter("l"), new ConsLoS("little ", new ConsLoS("lamb.", new MtLoS()))) && 
                t.checkExpect(this.mcDonaldSorted.filter("f"), new ConsLoS("farm.", new MtLoS()));
    }
}