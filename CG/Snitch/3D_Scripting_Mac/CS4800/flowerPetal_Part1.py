'''
This script is converted from a mel script that builds a flower.
'''
...
def flowerMaker():
	...
	if (createShader == 0):
		...
		''' Set attributes '''
		mc.setAttr("petalRamp.colorEntryList[3].color", 1, 0, 0, type="double3")
		mc.setAttr("petalRamp.colorEntryList[3].position", 1)

		mc.setAttr("petalRamp.colorEntryList[2].color", 1, 1, 0, type="double3")
		mc.setAttr("petalRamp.colorEntryList[2].position", 0.5)

		mc.setAttr("petalRamp.colorEntryList[1].color", 1, 0, 0, type="double3")
