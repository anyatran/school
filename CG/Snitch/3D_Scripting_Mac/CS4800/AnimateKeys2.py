...
def keyHome_Camera( keyTime ):
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='tx', value=42 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='ty', value=15 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='tz', value=28 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='rx', value=-18 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='ry', value=56 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='rz', value=0 )
...
def keyLow_Camera( keyTime ):
    ...
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='rx', value=17 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='ry', value=41 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='rz', value=0 )
...
def keyHead_Camera( keyTime ):
    ...
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='rx', value=-12 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='ry', value=-31 )
    cmds.setKeyframe( 'Animation_Camera', time=keyTime, attribute='rz', value=0 )
#keyHome_Camera( 1 )
#keyLow_Camera( 400 )
#keyHome_Camera( 800 )
